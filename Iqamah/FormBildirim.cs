    ...
    public partial class FormBildirim : Form
    {
        ...
        private void FormBildirim_Load(object sender, EventArgs e)
        {
            ...
            if (PrePrayerMode)
            {
                ...
                lblBaslik.Text = "⏰  PRAYER TIME IS APPROACHING";
                lblVakitAdi.Text = $"{VakitAdi} Prayer";
                lblSaat.Text = VakitSaati;
                lblMesaj.Text = $" {PrePrayerMinutes} left to prayer.";
            ...
            else
            {
                ...
                lblVakitAdi.Text = $"{VakitAdi} Prayer";
                lblSaat.Text = VakitSaati;
                lblMesaj.Text = "It's time for prayer!";
                ...
                if (ErtelemeSayisi >= MaxErteleme)
                {
                    ...
                    btnTamam.Location = new Point(118, 180);
                    btnTamam.Size = new Size(185, 42);
                    lblErteleInfo.Text = "Notifications for this prayer time will no longer be sent.";
